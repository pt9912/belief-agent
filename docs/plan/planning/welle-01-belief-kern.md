...
|---|---|---|---|
| `slice-001` | Domain-Typen: Hypothese, Belief State, Resthypothese | open | `LH-FA-BEL-001`, `LH-FA-BEL-003` |
| `slice-002` | Normierung + Validierung (Resthypothese-Pflicht, Toleranz) | open | `LH-FA-BEL-002`, `LH-FA-BEL-004` |
